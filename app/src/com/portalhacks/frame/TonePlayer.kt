...
/**
 * Synthesizes alert and doorbell chime tones in software into 16-bit 44.1kHz mono PCM AudioTrack.
 * Zero bundled audio files required. Played on USAGE_MEDIA stream so volume controls apply.
 */
object TonePlayer {
    ...
    fun play(name: String) {
        ...
        Thread {
            runCatching {
                ...
                Log.w(TAG, "Tone playback failed: ${it.message}")
            }
    ...
    private fun tone(freq: Double, seconds: Double, decay: Double): ShortArray {
        ...
        for (i in 0 until n) {
            ...
            // Fundamental plus a touch of 2nd harmonic for a pleasant bell timbre
